...
from . import views
from .views import HomeView, ArticleDetailView, AddPostView, UpdatePostView, DeletePostView, AddCommentView, search_user, AddCritiqueView, UpdateCritiqueView, DeleteCritiqueView, CritiqueDetailView, show_profile, FollowersListView
